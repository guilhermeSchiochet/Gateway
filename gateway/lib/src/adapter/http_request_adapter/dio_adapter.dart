...
class DioAdapter<T> implements HttpRequestAdapter {
 final _dio = Dio();
  ...
  @override
  Future<T> callGet(String url, { Map<String, String>? headers }) async {    
    try {
  ...
  @override
  Future<T> callPost(String url, { dynamic data, Map<String, String>? headers }) async {
    try {
